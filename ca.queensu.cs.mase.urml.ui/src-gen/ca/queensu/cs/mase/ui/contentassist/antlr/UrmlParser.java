		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getState_Access().getGroup_2(), "rule__State___Group_2__0");
					put(grammarAccess.getState_Access().getGroup_2_1(), "rule__State___Group_2_1__0");
					put(grammarAccess.getState_Access().getGroup_2_2(), "rule__State___Group_2_2__0");
					put(grammarAccess.getState_Access().getGroup_2_3(), "rule__State___Group_2_3__0");
					...
					put(grammarAccess.getVarDeclAccess().getNameAssignment(), "rule__VarDecl__NameAssignment");
					...
					put(grammarAccess.getSignalAccess().getVarDeclsAssignment_2_0(), "rule__Signal__VarDeclsAssignment_2_0");
					put(grammarAccess.getSignalAccess().getVarDeclsAssignment_2_1_1(), "rule__Signal__VarDeclsAssignment_2_1_1");
					...
					put(grammarAccess.getOperationAccess().getVarDeclsAssignment_3_0(), "rule__Operation__VarDeclsAssignment_3_0");
					put(grammarAccess.getOperationAccess().getVarDeclsAssignment_3_1_1(), "rule__Operation__VarDeclsAssignment_3_1_1");
					...
					put(grammarAccess.getState_Access().getNameAssignment_1(), "rule__State___NameAssignment_1");
					put(grammarAccess.getState_Access().getEntryCodeAssignment_2_1_2(), "rule__State___EntryCodeAssignment_2_1_2");
					put(grammarAccess.getState_Access().getExitCodeAssignment_2_2_2(), "rule__State___ExitCodeAssignment_2_2_2");
					put(grammarAccess.getState_Access().getSubstatemachineAssignment_2_3_1(), "rule__State___SubstatemachineAssignment_2_3_1");
