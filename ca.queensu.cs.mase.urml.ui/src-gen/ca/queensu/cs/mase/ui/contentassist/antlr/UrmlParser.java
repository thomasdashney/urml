		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getLocalVarAccess().getAlternatives_0(), "rule__LocalVar__Alternatives_0");
					...
					put(grammarAccess.getOperationAccess().getAlternatives_1(), "rule__Operation__Alternatives_1");
					...
					put(grammarAccess.getIncomingVariableAccess().getAlternatives_0(), "rule__IncomingVariable__Alternatives_0");
					...
					put(grammarAccess.getIncomingVariableAccess().getGroup(), "rule__IncomingVariable__Group__0");
					...
					put(grammarAccess.getLocalVarAccess().getIsBoolAssignment_0_0(), "rule__LocalVar__IsBoolAssignment_0_0");
					put(grammarAccess.getLocalVarAccess().getIsIntAssignment_0_1(), "rule__LocalVar__IsIntAssignment_0_1");
					put(grammarAccess.getLocalVarAccess().getNameAssignment_1(), "rule__LocalVar__NameAssignment_1");
					put(grammarAccess.getAttributeAccess().getIsBoolAssignment_1_0(), "rule__Attribute__IsBoolAssignment_1_0");
					put(grammarAccess.getAttributeAccess().getIsIntAssignment_1_1(), "rule__Attribute__IsIntAssignment_1_1");
					put(grammarAccess.getAttributeAccess().getNameAssignment_2(), "rule__Attribute__NameAssignment_2");
					put(grammarAccess.getAttributeAccess().getDefaultValueAssignment_3_1(), "rule__Attribute__DefaultValueAssignment_3_1");
					...
					put(grammarAccess.getOperationAccess().getIsBoolAssignment_1_0(), "rule__Operation__IsBoolAssignment_1_0");
					put(grammarAccess.getOperationAccess().getIsIntAssignment_1_1(), "rule__Operation__IsIntAssignment_1_1");
					put(grammarAccess.getOperationAccess().getIsVoidAssignment_1_2(), "rule__Operation__IsVoidAssignment_1_2");
					put(grammarAccess.getOperationAccess().getNameAssignment_2(), "rule__Operation__NameAssignment_2");
					put(grammarAccess.getOperationAccess().getLocalVarsAssignment_4_0(), "rule__Operation__LocalVarsAssignment_4_0");
					put(grammarAccess.getOperationAccess().getLocalVarsAssignment_4_1_1(), "rule__Operation__LocalVarsAssignment_4_1_1");
					put(grammarAccess.getOperationAccess().getOperationCodeAssignment_7(), "rule__Operation__OperationCodeAssignment_7");
					...
					put(grammarAccess.getTransitionAccess().getUniversalAssignment_8_1_2(), "rule__Transition__UniversalAssignment_8_1_2");
					...
					put(grammarAccess.getIncomingVariableAccess().getIsBoolAssignment_0_0(), "rule__IncomingVariable__IsBoolAssignment_0_0");
					put(grammarAccess.getIncomingVariableAccess().getIsIntAssignment_0_1(), "rule__IncomingVariable__IsIntAssignment_0_1");
					put(grammarAccess.getIncomingVariableAccess().getNameAssignment_1(), "rule__IncomingVariable__NameAssignment_1");
