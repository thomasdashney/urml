 ...
 * <ul>
 *   <li>{@link ca.queensu.cs.mase.urml.impl.AssignableImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AssignableImpl extends MinimalEObjectImpl.Container implements Assignable
{
  ...
  {
    return UrmlPackage.Literals.ASSIGNABLE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UrmlPackage.ASSIGNABLE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UrmlPackage.ASSIGNABLE__NAME:
        return getName();
    }
